...
@section('content')
                ...
                <fieldset class="fieldset mt-5">
                    ...
                    <div id="items-container">
                        <div class="item-row mb-2">
                            <select name="items[0][item_id]" class="input">
                                @foreach ($menuItems as $menu)
                                    <option value="{{ $menu->item_id }}">{{ $menu->name }} (Rp{{ $menu->price }})
                                    </option>
                                @endforeach
                            </select>
    ...
    <script>
        ...
        function tambahItem() {
            ...
            div.innerHTML = `
        <div class="gap-2">
            <select name="items[${itemIndex}][item_id]" class="input">
                @foreach ($menuItems as $menu)
        ...
        function lihatStruk(order) {
            ...
            let detailHTML = `
                                        <ul class="list bg-base-100 rounded-box shadow-md">
                                            <li class="p-4 py-1 text-bold text-md font-bold tracking-wide">Pelanggan:
